...
$j=0;
include('db.php');
    $sql="SELECT * FROM transfer_applications WHERE (ctestatus != 'PENDING TO SEE' OR ctestatus = 'APPROVED BY CTE' OR ctestatus = 'REJECT BY CTE')";
...
border-radius: 15px;">
    <a class="navbar-brand" href="#"><b>Welcome, CTE Member</b></a>
